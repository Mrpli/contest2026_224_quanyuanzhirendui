/****************************************************************************
 * vendor/openvela/boards/contest2026_224_board/include/board.h
 *
 * NUCLEO-N657X0-Q board definitions for STM32N657X0 (Cortex-M55).
 *
 * Adapted from nuttx/boards/arm/stm32n6/nucleo-n657x0-q/
 *
...
#ifndef __VENDOR_OPENVELA_BOARDS_CONTEST2026_224_BOARD_INCLUDE_BOARD_H
#define __VENDOR_OPENVELA_BOARDS_CONTEST2026_224_BOARD_INCLUDE_BOARD_H
 ...
 * domains; both are wired to the board's 1.8 V rail.
 */
...
/* LED state encoding for CONFIG_ARCH_LEDS */
...
#endif /* __ASSEMBLY__ */
#endif /* __VENDOR_OPENVELA_BOARDS_CONTEST2026_224_BOARD_INCLUDE_BOARD_H */
